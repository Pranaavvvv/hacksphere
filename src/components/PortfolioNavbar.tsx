      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              href="/auth"
              className="text-foreground px-4 py-2 rounded-full text-sm font-medium hover:bg-secondary transition-all duration-200"
              style={{
                fontFamily: "Figtree",
              }}
            >
            ...
            <button
              ...
              className="bg-primary text-white px-[18px] rounded-full text-base font-semibold hover:bg-primary/90 transition-all duration-200 hover:rounded-2xl shadow-sm hover:shadow-md whitespace-nowrap leading-4 py-[15px]"
              style={{
                fontFamily: "Plus Jakarta Sans, sans-serif",
              }}
            >
          ...
          >
            <div className="px-6 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-border space-y-2">
                <a
                  href="/auth"
                  className="w-full block text-center py-2 px-4 text-foreground border border-border rounded-full hover:bg-secondary transition-all"
                  style={{
                    fontFamily: "Figtree",
                  }}
                >
                ...
                <button
                  onClick={() => handleLinkClick("#contact")}
                  className="w-full bg-primary text-white px-[18px] py-[15px] rounded-full text-base font-semibold hover:bg-primary/90 transition-all duration-200"
                  style={{
                    fontFamily: "Plus Jakarta Sans, sans-serif",
                  }}
                >
