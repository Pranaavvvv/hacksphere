...
export const IntegrationCarousel = ({
  ...
  subtitle = "HackSphere integrates seamlessly with your college management systems, SSO, email platforms, and more for complete hackathon automation.",
  ...
  return (
    <div className="w-full py-16 sm:py-20 md:py-24 bg-white">
      <div className="max-w-[680px] mx-auto px-4 sm:px-6">
        ...
        >
          <div className="flex flex-col items-center gap-3 sm:gap-4">
            <h2
              className="text-2xl sm:text-3xl md:text-4xl lg:text-[40px] leading-tight font-normal text-[#222222] text-center tracking-tight mb-0"
              style={{
            ...
            <p
              className="text-base sm:text-lg leading-6 sm:leading-7 text-[#666666] text-center max-w-[600px] mt-2"
              style={{
                fontFamily: "var(--font-figtree), Figtree",
              }}
            >
          ...
          >
            <a
              href={buttonHref}
              className="inline-block px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-white text-[#222222] text-sm sm:text-[15px] font-medium leading-6 text-center whitespace-nowrap transition-all duration-75 ease-out w-auto sm:w-[182px] cursor-pointer hover:shadow-lg"
              style={{
                boxShadow:
      ...
      <div className="h-40 sm:h-56 md:h-[268px] -mt-2 sm:-mt-4 md:-mt-6 mb-0 pb-0 relative overflow-hidden">
        <div
          ref={topRowRef}
